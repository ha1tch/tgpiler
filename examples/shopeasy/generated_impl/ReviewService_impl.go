...
func (r *ReviewServiceRepositorySQL) CreateReview(ctx context.Context, req *CreateReviewRequest) (*CreateReviewResponse, error) {
	...
	_, err := r.db.ExecContext(ctx, query, req.ProductID, req.UserID, req.Rating, req.Title, req.Content)
	if err != nil {
...
func (r *ReviewServiceRepositorySQL) GetReview(ctx context.Context, req *GetReviewRequest) (*GetReviewResponse, error) {
	...
	var nested Review
	err := row.Scan(&nested.ID, &nested.ProductID, &nested.UserID, &nested.UserName, &nested.Rating, &nested.Title, &nested.Content, &nested.Status, &nested.VerifiedPurchase, &nested.HelpfulVotes, &nested.UnhelpfulVotes, &nested.CreatedAt, &nested.UpdatedAt)
	if err != nil {
...
func (r *ReviewServiceRepositorySQL) UpdateReview(ctx context.Context, req *UpdateReviewRequest) (*UpdateReviewResponse, error) {
	...
	_, err := r.db.ExecContext(ctx, query, req.ID, req.UserID, req.Rating, req.Title, req.Content)
	if err != nil {
...
func (r *ReviewServiceRepositorySQL) DeleteReview(ctx context.Context, req *DeleteReviewRequest) (*DeleteReviewResponse, error) {
	...
	var result DeleteReviewResponse
	err := row.Scan(&result.Success)
	if err != nil {
		if err == sql.ErrNoRows {
			return nil, fmt.Errorf("DeleteReview: not found")
		}
